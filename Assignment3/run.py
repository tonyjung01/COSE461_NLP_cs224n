...
Options:
    ...
    --cuda                                  use GPU
    --train-src=<file>                      train source file [default: ./zh_en_data/train.zh]
    --train-tgt=<file>                      train target file [default: ./zh_en_data/train.en]
    --dev-src=<file>                        dev source file [default: ./zh_en_data/dev.zh]
    --dev-tgt=<file>                        dev target file [default: ./zh_en_data/dev.en]
